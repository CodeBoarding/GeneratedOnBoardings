...
graph LR
    ...
    click HTTP_Request_Response_Processing href "https://github.com/CodeBoarding/GeneratedOnBoardings/blob/main//django/HTTP Request/Response Processing.md" "Details"
    click ORM_and_Database_Layer href "https://github.com/CodeBoarding/GeneratedOnBoardings/blob/main//django/ORM and Database Layer.md" "Details"
    click Template_Engine href "https://github.com/CodeBoarding/GeneratedOnBoardings/blob/main//django/Template Engine.md" "Details"
```
